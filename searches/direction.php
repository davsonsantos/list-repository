...
$repositories = $client->currentUser()->repositories(GIT_USER, 'full_name', $PostData['direction']);

if ($PostData['direction'] === 'commit') :
    array_multisort(array_map(function($element) {
        return $element['pushed_at'];
    }, $repositories), SORT_DESC, $repositories);
endif;
